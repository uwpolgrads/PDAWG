...
author: "Brian Leung"
date: "2024-02-21"
categories: [News, R, Python]
message: false
warning: false
---

Welcome to P-DAWG! This post introduces us to using Quarto (`.qmd`) to write a blog-style document that integrates `R` or `Python` code with text!
